...
# Create 2x2 layout for plot4
par(mfrow = c(2, 2))

# Create the plots for plot4
...
plot(data$Datetime, data$Voltage, xlab = "datetime", ylab = "Voltage", type = "l", xaxt = "n")
axis(side = 1, at = c(as.numeric(data$Datetime[1]), as.numeric(data$Datetime[1441]),as.numeric(data$Datetime[2880])), labels = c("Thu", "Fri", "Sat"))
...
plot(data$Datetime, data$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_Reactive-Power", xaxt = "n")
axis(side = 1, at = c(as.numeric(data$Datetime[1]), as.numeric(data$Datetime[1441]),as.numeric(data$Datetime[2880])), labels = c("Thu", "Fri", "Sat"))
